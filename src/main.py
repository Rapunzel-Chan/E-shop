...
class Smartphone(Product):
    """Класс для подсчета Смартфонов - класс-наследник Product"""
...
class LawnGrass(Product):
    """Класс для подсчета Травы газонной - класс-наследник Product"""
...
if __name__ == "__main__":
    ...
    grass1 = LawnGrass("Газонная трава", "Элитная трава для газона", 500.0,
                       20, "Россия", "7 дней", "Зеленый")
    grass2 = LawnGrass("Газонная трава 2", "Выносливая трава", 450.0,
